...
if (isset($_GET['order_id'])) {
     ...
     if (isset($_SESSION['id']) || $_SESSION['email']) {
          if (isset($_SESSION['id'])) {
               $getOrder = $order->getOrderById($id, $_SESSION['id']);
          } else if (isset($_SESSION['email'])) {
               $getOrder = $order->getOrderByEmail($id, $_SESSION['email']);
          }
          if ($getOrder->rowCount() != 0) {
               $getOrderDetail = $order_detail->getOrderDetail($id);
                                             ...
                                             <div class="card-body">
                                                  <div class="mb-3 d-flex justify-content-between fs-3">
                                                       <div>
                                                            ...
                                                            <span class="me-3"><?= $payment_method->getPaymentMethodById($setOrder['payment_method'])->fetch()['name_method'] ?></span>
                                                            <span class="badge rounded-pill bg-info fs-4"><?= $order_status->getOrderStatusById($setOrder['status'])->fetch()['name']; ?></span>
                                                       </div>
                                                  </div>
                                                                                ...
                                                                                <div class="d-flex mb-2">
                                                                                     ...
                                                                                     <div class="flex-lg-grow-1 ms-3">
                                                                                          <div class="product-info">
                                                                                               ...
                                                                                               <?php $getSize = $size->getSize($setOrderDetail['size_id'])->fetch();
                                                                                               ...
                                                                                               ?>
                                                                                                    ...
                                                                                                    if (strlen($setOrderDetail['topping_id']) > 1) {
                                                                                                         ...
                                                                                                         foreach ($list_topping as $each) {
                                                                                                              $i++;
                                                                                                              $getTopping = $topping->getTopping($each)->fetch();
                                                                                                              $priceProduct += intval($getTopping['price']);
                                                                                                              if ($i != 1) {
                                                                                                                   echo ', ';
                                                                                                              }
                                                                                                              echo $getTopping['name'];
                                                                                                         }
                                                                                                    } else {
                                                                                                         $getTopping = $topping->getTopping($setOrderDetail['topping_id'])->fetch();
                                                                                                         $priceProduct += intval($getTopping['price']);
                                             ...
                                             <div class="card-body">
                                                  <div class="row">
                                                       <div class="col-lg-6">
                                                            ...
                                                            <p><?= $payment_method->getPaymentMethodById($setOrder['payment_method'])->fetch()['name_method'] ?><br>
